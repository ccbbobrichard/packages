...
class FengNiaoPayment extends PaymentInterface
{
    ...
    private $pre_url = "https://vip.asfd.xyz/";

    function __construct($filename = "")
    {
        parent::__construct($filename ?: 'FengNiaoPayment');
        $this->pre_name = "蜂鸟支付，";
        $this->channel_id = App::make(ChannelIdByClassNameService::class)->excute("FengNiaoPayment");
    ...
    private function sign($arr,$api_type = 1)
    {
        ...
        bob_newlog("签名字符串",['str'=>$md5str . "key=" . $api_key,'sign'=>strtolower(md5($md5str."key=".$api_key))],$this->filename);
        return strtolower(md5($md5str."key=".$api_key));
    }
